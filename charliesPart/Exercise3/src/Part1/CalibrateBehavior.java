...
public class CalibrateBehavior implements Behavior {
	...
	public void action() {
		...
		geoff.rotate(385, true);//380 due to error in turning circle
		...
		System.out.println(geoff.getLeftLight().getLow());
		System.out.println(geoff.getLeftLight().getHigh());
		System.out.println(geoff.getRightLight().getLow());
		System.out.println(geoff.getRightLight().getHigh());
